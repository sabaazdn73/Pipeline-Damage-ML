...
## Overview
This project develops ML-based surrogate models for pipeline 
damage detection, combining simplified FEM simulations with 
machine learning and uncertainty quantification.

## Research Motivation
Inspired by real-world pipeline integrity assessment 
(similar to Enbridge pipeline monitoring systems).
...
## Key Results
Gaussian Process Regressor achieves R²=0.997 with 
uncertainty bounds — critical for safety-critical 
pipeline decisions.
